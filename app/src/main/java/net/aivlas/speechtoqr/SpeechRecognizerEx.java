...
// SpeechRecognizerEx
public class SpeechRecognizerEx extends Activity {
    // 定数
    ...
    public void onCreate(Bundle bundle) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplication(),QrCodeGenerateActivity.class);
                String data ="";


                try {
                    data = (String) texts.get(0);
                } catch (Exception e) {
                    data = "no_content";
                    e.printStackTrace();
                }
                ...
                //final Intent qrCodeGenerate = intent.setClassName("net.npaka.speechrecognizerex","QrCodeGenerateActivity");
